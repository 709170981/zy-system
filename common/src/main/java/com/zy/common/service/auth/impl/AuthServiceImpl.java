package com.zy.common.service.auth.impl;
...
import com.zy.common.context.CurrentDataSourceContext;
...
import com.zy.common.exception.AuthException;
import com.zy.common.exception.ServiceException;
import com.zy.common.exception.TenantException;
import com.zy.common.exception.enums.AuthExceptionEnum;
import com.zy.common.exception.enums.ServerExceptionEnum;
import com.zy.common.exception.enums.TenantExceptionEnum;
import com.zy.common.factory.LoginUserFactory;
...
import com.zy.common.service.tenant.TenantInfoService;
...
import com.zy.common.utils.JwtTokenUtil;
...
public class AuthServiceImpl implements AuthService, UserDetailsService {
    ...
    private void cacheLoginUser(JwtPayLoad jwtPayLoad, SysLoginUser sysLoginUser) {
        ...
        userCache.put(redisLoginUserKey, sysLoginUser, 7200L);
    }
}
